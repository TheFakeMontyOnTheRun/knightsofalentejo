...
public class GameActivity extends AppCompatActivity implements OnItemSelectedListener, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToggleCameraButton = findViewById(R.id.btnToggleCamera);
    ...
    private void restoreGameSession(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(level).setDelegates(gameDelegate, view.getRenderingDelegate());
    ...
    private List<Integer> getGameControllerIds() {
        ...
        for (int deviceId : deviceIds) {
            ...
            int sources = Objects.requireNonNull(dev).getSources();
